...
export async function proxy(request: NextRequest) {
  ...
  const isDashboardRoute = request.nextUrl.pathname.startsWith('/batalha') ||
    ...
    request.nextUrl.pathname.startsWith('/bestiario') ||
    request.nextUrl.pathname.startsWith('/magias') ||
    request.nextUrl.pathname.startsWith('/itens') ||
    request.nextUrl.pathname.startsWith('/aventura') ||
