...
export const CONDICOES: Condicao[] = [
  ...
  {
    id: '4', nome: 'Caído', icone: '⬇️', sistema: 'dnd5e',
  ...
  {
    id: '5', nome: 'Cego', icone: '🙈', sistema: 'dnd5e',
  ...
  {
    id: '6', nome: 'Desacordado', icone: '💤', sistema: 'dnd5e',
    descricao: 'A criatura está inconsciente por causas não mágicas (como dano de morte).',
  ...
  {
    id: '7', nome: 'Enfeitiçado', icone: '💜', sistema: 'dnd5e',
    descricao: 'A criatura está enfeitiçada por outra.',
    efeitos: ['Não pode atacar o enfeitiçador', 'O enfeitiçador tem vantagem em testes de habilidade para interagir socialmente com a criatura'],
    como_sair: 'Depende do efeito que causou a condição.',
  },
  {
  ...
  {
    id: '9', nome: 'Exaustão', icone: '😴', sistema: 'dnd5e',
  ...
  {
    id: '10', nome: 'Impedido', icone: '🕸️', sistema: 'dnd5e',
  ...
  {
    id: '11', nome: 'Incapacitado', icone: '🚫', sistema: 'dnd5e',
    descricao: 'A criatura não pode realizar ações ou reações.',
    efeitos: ['Não pode realizar ações', 'Não pode realizar reações'],
    como_sair: 'Depende do efeito que causou a condição.',
  },
  {
    id: '12', nome: 'Inconsciente', icone: '💤', sistema: 'dnd5e',
    descricao: 'A criatura está inconsciente por efeito mágico.',
    efeitos: ['Incapacitada e não pode se mover nem falar', 'Cai no chão', 'Falha automaticamente em salvaguardas de Força e Destreza', 'Jogadas de ataque contra ela têm vantagem', 'Qualquer ataque que a acerte é um acerto crítico se o atacante estiver a 1,5m'],
    como_sair: 'Depende do efeito. Dano pode acordar a criatura.',
  },
  {
    id: '13', nome: 'Invisível', icone: '👻', sistema: 'dnd5e',
  ...
  {
    id: '14', nome: 'Paralisado', icone: '🧊', sistema: 'dnd5e',
  ...
  {
    id: '15', nome: 'Petrificado', icone: '🗿', sistema: 'dnd5e',
  ...
  {
    id: '16', nome: 'Surdo', icone: '🔇', sistema: 'dnd5e',
    descricao: 'A criatura não pode ouvir.',
    efeitos: ['Falha automaticamente em qualquer teste que exija audição'],
    como_sair: 'Depende do efeito que causou a condição.',
  },
]
...
export const TODAS_CONDICOES: TipoCondicao[] = [
  ...
  'Desacordado', 'Enfeitiçado', 'Envenenado', 'Exaustão', 'Impedido',
  'Incapacitado', 'Inconsciente', 'Invisível', 'Paralisado', 'Petrificado',
  'Surdo',
]
